...
```javascript
new Chartkick.LineChart("chart", {"2026-01-01": 11, "2026-01-02": 6})
```
...
```javascript
new Chartkick.AreaChart("chart", {"2026-01-01": 11, "2026-01-02": 6})
```
...
```javascript
new Chartkick.LineChart("chart", [["2026-01-01", 2], ["2026-01-02", 3]])
```
...
```javascript
new Chartkick.LineChart("chart", data, {xmin: "2026-01-01", xmax: "2026-02-01"})
```
